...
Experienced Backend and Full Stack Software Developer with over 30 years of background in web and desktop development, with deep expertise in relational databases, programming languages, and system architecture. Skilled in both on-premises and cloud-based environments.

📌 Currently working as a Senior Data Analyst, focusing on data engineering using Python — designing, building, and maintaining data pipelines and automation processes.

Proven ability to deliver IT solutions aligned with business goals, lead development and support teams, and mentor professionals across disciplines. Adaptable, fast learner, and problem solver under pressure.
...
#### Past Experience (Used Extensively in the Past)

- Languages: [![PHP](https://img.shields.io/badge/PHP_%7C_8_y-4F5B93?logo=php&logoColor=white)](#)
[![Delphi](https://img.shields.io/badge/Delphi_%7C_15_y-b21f24?logo=delphi&logoColor=black)](#)
- Databases: [![Firebird](https://img.shields.io/badge/Firebird_%7C_20_y-ff0000.svg?logo=firebird&logoColor=white)](#)

#### Familiar With (Studied or Used Occasionally)
